...
margin  <- "ebf" # ebf: empirical basis functions, 2bs: B Splines in 2d
L       <- 4     # number of knots for ebf or df^2 for 2bs
                 # if margin == ebf and L = 4, using 2nd order spatial trend
